...
const TRIP = {
  ...
  bookings: [
    { name: 'Lexis Hibiscus', status: 'BOOKED', note: '10/5–10/6，已预订' },
    { name: 'Petronas Towers 外观', status: 'NOT REQUIRED', note: 'Ground View / Exterior，免费，不登塔' },
    { name: 'Melaka Bus', status: 'TO BOOK', note: 'TBS ↔ Melaka Sentral，出发前确认班次' },
    { name: 'Aquaria KLCC', status: 'TO BOOK', note: '10/3 下午，票价与入场规则出发前确认' },
    { name: 'Zoo Negara', status: 'TO BOOK', note: '10/5 上午，票价与开放安排出发前确认' },
    { name: 'D4 Private Transfer', status: 'TO BOOK', note: 'MOV → Zoo Negara → Lexis Hibiscus' },
    { name: 'D5 Airport Transfer', status: 'TO BOOK', note: 'Lexis Hibiscus → KUL T1，提前预约' }
  ],
  days: [
    {
      ...
      spots: [
        ...
        { time: '14:20–15:30', type: 'transit', emoji: '🛬', zh: '吉隆坡国际机场 T1', en: 'Kuala Lumpur International Airport T1',
        ...
        { time: '16:45–18:00', type: 'hotel', emoji: '🏨', zh: 'MOV Hotel', en: 'MOV Hotel Kuala Lumpur',
        ...
        { time: '18:15–19:00', type: 'shopping', emoji: '🛍️', zh: 'Pavilion 吉隆坡', en: 'Pavilion Kuala Lumpur',
        ...
        { time: '19:00–20:30', type: 'food', emoji: '🍜', zh: '阿罗街', en: 'Jalan Alor Food Street',
    ...
    },
    {
      ...
      summary: { spots: 12, walks: '约 4 km', grabs: 3, budget: 'RM 80–140 / 人（Aquaria 票价出发前确认）' },
      transport: {
      ...
      spots: [
        { time: '07:00–08:00', type: 'hotel', emoji: '🏨', zh: 'MOV Hotel', en: 'MOV Hotel Kuala Lumpur',
        ...
        { time: '08:30–09:40', type: 'attraction', emoji: '🛕', zh: '黑风洞', en: 'Batu Caves',
        ...
        { time: '13:00–13:30', type: 'attraction', emoji: '🏮', zh: '茨厂街', en: 'Petaling Street / Chinatown',
        ...
        { time: '13:30–13:50', type: 'attraction', emoji: '🏮', zh: '鬼仔巷', en: 'Kwai Chai Hong',
        ...
        { time: '13:55–14:30', type: 'attraction', emoji: '🎨', zh: '中央艺术坊', en: 'Central Market Kuala Lumpur',
        ...
        { time: '14:40–15:15', type: 'attraction', emoji: '🏛️', zh: '独立广场', en: 'Merdeka Square',
        ...
        { time: '15:40–16:40', type: 'hotel', emoji: '🏨', zh: 'MOV Hotel', en: 'MOV Hotel Kuala Lumpur',
        ...
        { time: '17:00–18:45', type: 'attraction', emoji: '🐠', zh: 'Aquaria KLCC 水族馆', en: 'Aquaria KLCC',
          note: '马来西亚 / 东南亚水生生态系统；重点看绿海龟、大石斑鱼、海鳗、竹鲨、鲎、射水鱼、弹涂鱼与水下隧道', lat: 3.1534, lng: 101.7133,
          address: 'Kuala Lumpur Convention Centre, Jalan Pinang, 50088 Kuala Lumpur',
          duration: '约 1 小时 45 分钟', openingHours: '10:00–20:00（最后入场时间出发前确认）', ticket: '需购票，价格与规则出发前确认',
          tips: ['室内景点，天气不好时作为 D2 核心活动','重点看 underwater tunnel 与 Malaysian / Southeast Asian aquatic ecosystem'],
          next: { mode: 'walk', text: '步行至 KLCC Park（约 5 分钟）' }
        },
        { time: '18:45–19:15', type: 'attraction', emoji: '🌳', zh: 'KLCC Park', en: 'KLCC Park',
          note: '短暂散步与休息', lat: 3.1548, lng: 101.7120,
          address: 'Kuala Lumpur City Centre, 50088 Kuala Lumpur',
          duration: '约 30 分钟', openingHours: '—', ticket: '免费',
          tips: ['不安排额外路线','天气不好可缩短停留'],
          next: { mode: 'walk', text: '步行至双子塔外部拍照点（约 5 分钟）' }
        },
        { time: '19:15–19:45', type: 'attraction', emoji: '🌉', zh: '双子塔外观', en: 'Petronas Twin Towers Exterior',
          ...
          note: 'Ground View / Exterior 外部拍照；不登塔、不需要门票', lat: 3.1580, lng: 101.7116,
          address: 'Kuala Lumpur City Centre, 50088 Kuala Lumpur',
          duration: '约 30 分钟', openingHours: '外部全天可见', ticket: 'FREE / 不需要票',
          tips: ['只拍外观','Ground View 免费停留即可'],
          next: { mode: 'walk', text: '步行至 Suria KLCC 晚餐（约 5 分钟）' }
        }
      ],
      restaurants: [
        ...
        { meal: 'dinner', time: '约 20:15',
          name: 'Suria KLCC', zhName: 'Suria KLCC 晚餐',
          cuisine: '商场美食 / 街头美食', tags: ['Mixed'],
          recommendedDishes: ['商场内各式档口','本地马来西亚料理'],
          pricePerPerson: 'RM 25–50', openingHours: '商场 10:00–22:00 / 阿罗街 17:00–01:00',
          distanceFromPrev: '双子塔外观旁，步行约 5 分钟',
    ...
    },
    {
      ...
      spots: [
        { time: '06:30–07:30', type: 'hotel', emoji: '🏨', zh: 'MOV Hotel', en: 'MOV Hotel Kuala Lumpur',
        ...
        { time: '11:00–11:30', type: 'transit', emoji: '🚏', zh: 'Melaka Sentral 马六甲中央车站', en: 'Melaka Sentral',
        ...
        { time: '11:30–12:10', type: 'attraction', emoji: '🏛️', zh: '马六甲红屋', en: 'Dutch Square / The Stadthuys',
        ...
        { time: '13:00–13:40', type: 'attraction', emoji: '⛪', zh: '圣保罗山', en: "St. Paul's Hill Melaka",
        ...
        { time: '13:50–14:35', type: 'attraction', emoji: '🏠', zh: '峇峇娘惹祖屋', en: 'Baba & Nyonya Heritage Museum',
          note: '可选/推荐（太累可删）', lat: 2.1956, lng: 102.2462,
          address: '48-50, Jalan Tun Tan Cheng Lock, 75200 Malacca',
          duration: '约 45 分钟', openingHours: '开放时间与导览场次出发前确认', ticket: '票价出发前确认',
          tips: ['需跟随导览','内部禁止拍照','前一晚睡不好可现场删（已有国家博物馆）'],
          next: { mode: 'walk', text: '步行至 Cendol / 咖啡休息（约 5 分钟）' }
        },
        { time: '15:15–15:40', type: 'attraction', emoji: '🛕', zh: '青云亭', en: 'Cheng Hoon Teng Temple',
        ...
        { time: '16:00–16:50', type: 'attraction', emoji: '🛶', zh: '马六甲河游船', en: 'Melaka River Cruise',
          ...
          duration: '约 50 分钟', openingHours: '场次与开放时间出发前确认', ticket: '票价出发前确认',
          tips: ['沿河可看到彩色壁画建筑'],
          next: { mode: 'walk', text: '咖啡馆 / 休息（17:00–17:50）' }
        },
        { time: '18:00–19:40', type: 'food', emoji: '🏮', zh: '鸡场街夜市', en: 'Jonker Street Night Market',
          note: '周末夜市（今晚是周日，晚餐直接解决）', lat: 2.1967, lng: 102.2460,
          address: 'Jalan Hang Jebat, 75200 Malacca',
          duration: '约 1 小时 40 分钟', openingHours: '周末夜市时间出发前确认', ticket: '无',
    ...
    },
    {
      ...
      spots: [
        { time: '08:15–09:30', type: 'hotel', emoji: '🏨', zh: 'MOV Hotel', en: 'MOV Hotel Kuala Lumpur',
        ...
        { time: '10:00–13:00', type: 'attraction', emoji: '🦁', zh: 'Zoo Negara 国家动物园', en: 'Zoo Negara Malaysia',
          ...
          duration: '约 3 小时', openingHours: '开放时间与最后入场出发前确认', ticket: '门票与 Tram 规则出发前确认',
        ...
        { time: '15:30–16:45', type: 'hotel', emoji: '🏨', zh: 'Lexis Hibiscus Port Dickson', en: 'Lexis Hibiscus Port Dickson',
        ...
        { time: '16:45–19:15', type: 'attraction', emoji: '🏖️', zh: 'Lexis Hibiscus 海边', en: 'Lexis Hibiscus Beach & Resort',
        ...
        { time: '19:30–20:45', type: 'food', emoji: '🍽️', zh: '酒店晚餐', en: 'Lexis Hibiscus Dinner',
    ...
    },
    {
      ...
      spots: [
        ...
        { time: '11:00–12:15', type: 'transit', emoji: '🚗', zh: '前往机场', en: 'To KUL T1',
        ...
        { time: '12:15–15:20', type: 'transit', emoji: '🛫', zh: '吉隆坡国际机场 T1', en: 'Kuala Lumpur International Airport T1',
...
// Shared UX metadata: Timeline and map read the same priority/optional flags.
(function enrichItinerary() {
  var priorities = {
    '峇峇娘惹祖屋': 'OPTIONAL',
    '马六甲河游船': 'OPTIONAL',
    '鬼仔巷': 'PASS-BY / QUICK STOP',
    '中央艺术坊': 'PASS-BY / QUICK STOP',
    'Pavilion 吉隆坡': 'PASS-BY / QUICK STOP',
    'MOV Hotel': 'REST',
    'Lexis Hibiscus': 'REST',
    'Lexis Hibiscus Port Dickson': 'REST',
    'TBS 南湖镇车站': 'TRANSPORT',
    'Melaka Sentral 马六甲中央车站': 'TRANSPORT'
  };
  TRIP.days.forEach(function (day) {
    day.spots.forEach(function (spot) {
      spot.priority = spot.priority || priorities[spot.zh] || (spot.type === 'transit' ? 'TRANSPORT' : 'MUST');
      spot.optional = spot.optional === true || spot.priority === 'OPTIONAL';
      spot.weatherSensitive = spot.weatherSensitive === true || spot.zh === 'Zoo Negara 国家动物园';
    });
  });
  TRIP.days[1].planB = '天气不好时：Aquaria KLCC 是室内核心活动；双子塔只保留外观拍照。';
  TRIP.days[2].planB = '下雨或时间不足时：删除 Melaka River Cruise；长途巴士晚点时，TBS 直接 Grab 回 MOV。';
  TRIP.days[2].returnPlans = [
    { title: 'Normal Route', text: 'Melaka Sentral → 20:30–21:00 巴士 → TBS → LRT Bandar Tasik Selatan → Monorail Hang Tuah → Bukit Bintang → 步行 MOV' },
    { title: 'Late-night fallback', text: '如果巴士严重晚点或接近轨道末班车：TBS 下车后直接 Grab 回 MOV。' }
  ];
  TRIP.days[3].planB = 'Zoo Negara 对天气敏感；下雨时减少户外停留，优先确认动物园开放安排。';
  TRIP.days[4].planB = 'Lexis → KUL T1 必须提前预约酒店机场接送，不依赖当天临时 Grab。';
})();
